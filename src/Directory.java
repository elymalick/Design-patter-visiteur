...
//classe reprsentant un dossier
{
	...
	//affiche  l'cran la liste des lments qu'il contient
	{
		for (ElementStockage s : listeDossier)
		{
			...
			System.out.println(s.basicSize) ;
		}
	}
...
//	for(ElementStockage e :listeDossier)
//	{
//		
//		e.accept(v);
//		
...
//		listeDossier.add(component);
  //  }
	
//	protected boolean isTree(Set visited) {
//		visited.add(this);
//		Iterator i = listeDossier.iterator();
//		while (i.hasNext()) {
//		ElementStockage c = (ElementStockage)i.next();
