...
//		File f3 = new File("Glacons.class","glacons") ;
//
//		d.add(f) ;
//		d.add(f2) ;
//		d2.add(f3) ;
...
//		*/
		...
		d2.add(new Symlink("symblink F1.java")) ;
		d2.add(new File("F2.java","...")) ;
		d3.add(new File(" F1.class","...")) ;
		d3.add(new File("F2.class","...")) ;
		d3.add(new Link("link F2.class","...")) ;
		d3.add(new File("F3.class","...")) ;
		//d3.add(new Link("sources", d2));
	//	ComptageVisitor c = new ComptageVisitor();
	//	d.accept(c);
	//	System.out.println(c.getCount());

		//................................................prettyPrint
		
		PrettyPrintVisitor c = new PrettyPrintVisitor();
			d.accept(c);
	}
}